...
<body>
                            ...
                            ?>
                                <div>
                                    ...
                                    <span class="badge bg-light text-dark border border-secondary"
                                        style="font-size:1.2rem;padding:8px 12px;"><i class="bi bi-calendar2-week"></i>
                                        Criado em:
                                        <?= isset($plano['criado_em']) ? date('d/m/Y', strtotime($plano['criado_em'])) : '-' ?></span>
                                    <span
                                        class="badge <?= $plano['status'] === 'concluido' ? 'bg-success' : 'bg-warning text-dark' ?> border border-<?= $plano['status'] === 'concluido' ? 'success' : 'warning' ?>"
                            ...
                            <div class="wizard-stepper-capitulos mb-4" id="wizard-stepper-<?= $plano['id'] ?>">
                                <div class="d-flex flex-row align-items-center justify-content-center gap-4 mb-3"
                                    ...
                                    <button class="btn btn-outline-primary me-2"
                                        id="wizard-prev-top-<?= $plano['id'] ?>" style="min-width:90px;"><i
                                            class="bi bi-arrow-left"></i> Anterior</button>
                                    ...
                                    <button class="btn btn-outline-primary ms-2"
                                        id="wizard-next-top-<?= $plano['id'] ?>" style="min-width:90px;">Próximo <i
                                ...
                                <div class="wizard-step-content position-relative" style="min-height:340px;">
                                    ...
                                    <div class="wizard-step-card" data-step="<?= $idx ?>"
                                                    ...
                                                    <div class="card-body d-flex flex-column <?= ($capStatus === 'cancelado' || $capStatus === 'concluido') ? 'opacity-50' : '' ?>"
                                                        ...
                                                        <div class="mb-2 d-flex flex-wrap gap-3 align-items-center"
                                                            ...
                                                            <div class="ms-auto d-flex gap-2 action-btns-on-top"
                                                                ...
                                                                <span
                                                                    style="display:inline-flex;align-items:center;justify-content:center;width:48px;height:48px;background:rgba(255,255,255,0.7);border-radius:50%;box-shadow:0 2px 8px #0002;z-index:51;">
                                                                    <button
                                                                        class="btn btn-toggle-no-border btn-outline-secondary btn-sm"
                                                                        ...
                                                                        <i
                                                                            class="bi <?= $cap['status'] === 'cancelado' ? 'bi-toggle-on' : 'bi-toggle-off' ?>"></i>
                                                                    </button>
                                                                </span>
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                style="background: linear-gradient(90deg, #e3f0ff 80%, #f8fafc 100%); border: 1.5px solid #b6d4fe; border-radius: 12px; box-shadow: 0 2px 8px #0d6efd11; padding: 15px 20px; display: flex; align-items: center; gap: 12px; min-height: 45px;">
                                                                <i class="bi bi-card-text text-primary"
                                                                    style="font-size:1.4rem;"></i>
                                                                <span
                                                                    style="color:#222; font-size:1.25rem; line-height:1.6; white-space:pre-line; word-break:break-word;">
                                                            ...
                                                            <div class="mb-3 p-3 rounded shadow-sm <?= $topClass ?>"
                                                                ...
                                                                <div class="<?= ($topStatus === 'cancelado' || $topStatus === 'concluido') ? 'opacity-50' : '' ?>"
                                                                    ...
                                                                    <div class="d-flex align-items-center mb-1">
                                                                        ...
                                                                        <div
                                                                            class="ms-auto d-flex gap-2 action-btns-on-top">
                                                                            <button class="btn btn-primary btn-sm"
                                                                                title="Editar Tópico"
                                                                                style="font-size:1.08rem;"
                                                                            ...
                                                                            <span
                                                                                style="display:inline-flex;align-items:center;justify-content:center;width:44px;height:44px;border-radius:50%;box-shadow:0 2px 8px #0002;z-index:51;">
                                                                                <button
                                                                                    class="btn btn-toggle-no-border btn-outline-secondary btn-sm"
                                                                                    ...
                                                                                    <i
                                                                                        class="bi <?= $top['status'] === 'cancelado' ? 'bi-toggle-on' : 'bi-toggle-off' ?>"></i>
                                                                                </button>
                                                                            </span>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-3">
                                            <button class="btn btn-outline-primary" id="wizard-prev-<?= $plano['id'] ?>"
                                                style="min-width:100px;"><i class="bi bi-arrow-left"></i>
                                                Anterior</button>
                                            <button class="btn btn-outline-primary" id="wizard-next-<?= $plano['id'] ?>"
                                                style="min-width:100px;">Próximo <i
                                                    class="bi bi-arrow-right"></i></button>
                                        </div>
                                    </div>
                                    <?php endforeach; ?>
    ...
    function abrirModalExcluirCapitulo(id, titulo) {
        ...
        document.getElementById('excluir_nome_capitulo').innerHTML = 'Tem certeza que deseja excluir o capítulo <b>' +
            titulo + '</b>?';
